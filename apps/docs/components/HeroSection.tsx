    ...
    <section className="relative bg-gradient-to-br from-[#F8F9FA] to-white py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Hero Image */}
          <div className="relative [animation:slide-in-left_0.6s_ease-out]">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 bg-[#E23744] text-white px-4 py-2 rounded-full font-semibold animate-bounce">
              ⭐ 4.9/5 Rating
            </div>
